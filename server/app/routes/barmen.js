...
//router.post('/:id(\\d+)/services', guard.check('barman:read, service:write'), am(barmanController.createServicesForBarman));
//router.post('/:id(\\d+)/services', guard.check('barman:read, service:write'), am(barmanController.deleteServicesForBarman));
